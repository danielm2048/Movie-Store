...
const Footer = () => {
	...
	return (
		...
		>
					...
					<FooterMenuList horizontal>
						...
						<FooterMenuItem>
							<a
								...
								rel="noopener noreferrer"
							>
								<GithubOutline size="24" color="white" />
							</a>
						</FooterMenuItem>

						<FooterMenuItem>
							<a
								href="mailto:danielmimoun98@gmail.com"
								target="_blank"
								rel="noopener noreferrer"
							>
								<AtOutline size="24" color="white" />
							</a>
						</FooterMenuItem>

						<FooterMenuItem>
							<a
								href="https://danielm2048.github.io/Portfolio"
								target="_blank"
								rel="noopener noreferrer"
							>
								<LayersOutline size="24" color="white" />
							</a>
						</FooterMenuItem>
					</FooterMenuList>
				</FooterMenu>
			...
			>
				<CodeOutline size="18" /> with <HeartOutline size="18" /> by Daniel
				Mimoun
			</div>
		</div>
	);
